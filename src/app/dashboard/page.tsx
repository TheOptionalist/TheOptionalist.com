...
const demoPayments = [
  { item: "Human Evolution Sprint", amount: "?299", date: "2026-01-22" },
  { item: "Political Theory Core", amount: "?299", date: "2026-01-30" }
];
  ...
  return (
    <section className="dashboard-shell">
      ...
      <div className="dashboard-grid">
        ...
        <div className="dashboard-panel">
          ...
          <div className="progress-card">
            <div>
              <h4>Weekly target</h4>
              <p>Complete 4 lessons + 2 answer drafts.</p>
            </div>
      ...
      <p className="dashboard-note">
        ...
        Once payments + course data are connected, these will update automatically.
      </p>
    </section>
  );
}
